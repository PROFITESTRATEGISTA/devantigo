...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'subscription.tokenReload': 'Token Reload',
    'subscription.tokenUsage': 'Token Usage',
    'subscription.monthlyAllocation': 'Monthly Allocation',
    'subscription.available': 'Available',
    'subscription.usedThisMonth': 'Used This Month',
    'subscription.resetsIn': 'Resets In',
    'subscription.needMoreTokens': 'Need more tokens?',
    'subscription.purchaseAdditional': 'Purchase additional tokens to continue using AI features',
    'subscription.perReload': 'per reload',
    ...
    'analyses.shareAnalysis': 'Share Analysis',
  ...
  pt: {
    ...
    'subscription.contract': 'Contratar',
    'subscription.downgrade': 'Fazer Downgrade',
    'subscription.tokenReload': 'Recarga de Tokens',
    'subscription.tokenUsage': 'Uso de Tokens',
    'subscription.monthlyAllocation': 'Alocação Mensal',
    'subscription.available': 'Disponível',
    'subscription.usedThisMonth': 'Usado Este Mês',
    'subscription.resetsIn': 'Renova Em',
    'subscription.needMoreTokens': 'Precisa de mais tokens?',
    'subscription.purchaseAdditional': 'Compre tokens adicionais para continuar usando recursos de IA',
    'subscription.perReload': 'por recarga',
