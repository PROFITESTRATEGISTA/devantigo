/*
  ...
  This migration fixes the codes view to properly map between owner_id and user_id
  and ensures all rules work correctly with the robots table structure.

  1. Changes
    - Drop existing view and rules
    - Recreate view with correct column mapping
    - Add proper rules for INSERT/UPDATE/DELETE operations
*/

-- Drop existing view and rules
DROP VIEW IF EXISTS codes CASCADE;

-- Recreate codes view with correct column mapping
